...
def get_hike(request):
    ...
    logger.info('request from %s for hike %s', repr(visitor_id), repr(request_hike_id))
...
def get_hikes_in_window(request):
    ...
    logger.info('got request from %s for hikes in window %s', repr(visitor_id), request_bounding_box)
...
def get_hikes_of_user(request):
    ...
    logger.info('request from %s for hikes of user %s', repr(visitor_id), repr(request_user_id))
...
def get_hikes_with_keywords(request):
    ...
    keywords = re.findall("[a-z0-9]{3,}", request_keywords.lower())
    logger.info('request from %s for hikes with keywords %s', repr(visitor_id), repr(keywords))
...
def post_hike(request):
    ...
    logger.info('request from %s to post hike %s', repr(visitor_id), repr(request.body))
    ...
    if(hike.request_hike_id >= 0):
        old_hike_key = ndb.Key(Hike, hike.request_hike_id)
        old_hike = old_hike_key.get()
...
def delete_hike(request):
    ...
    logger.info('request from %s to delete hike %s', repr(visitor_id), repr(delete_hike_id))
...
def post_user(request):
    ...
    logger.info('request from %s to post user %s', repr(visitor_id), repr(request.body))
...
def get_user(request):
    ...
    request_user_id = int(request.META.get('HTTP_USER_ID', -1))
    logger.info('request from %s to get user %s', repr(visitor_id), repr(request_user_id))
...
def delete_user(request):
    ...
    logger.info('request from %s to delete user %s', repr(visitor_id), repr(delete_user_id))
...
def post_image(request):
    ...
    logger.info('request from %s to post image %s', repr(visitor_id), repr(request_image_id))
...
def get_image(request):
    ...
    request_image_id = int(request.META.get('HTTP_IMAGE_ID', -1))
    logger.info('request from %s to get image %s', repr(visitor_id), repr(request_image_id))
...
def delete_image(request):
    ...
    logger.info('request from %s to delete image %s', repr(visitor_id), repr(delete_image_id))
...
def post_comment(request):
    ...
    logger.info('request from %s to post comment %s', repr(visitor_id), repr(request.body))
...
def delete_comment(request):
    ...
    logger.info('request from %s to delete comment %s', repr(visitor_id), repr(delete_comment_id))
...
def post_vote(request):
    ...
    logger.info('request from %s to post vote %s', repr(visitor_id), repr(request.body))
